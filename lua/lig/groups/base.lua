...
function M.get(c, opts)
  return {
    ...
    Cursor = { reverse = true },
    lCursor = { bg = c.bg_reversed, fg = c.fg_reversed },
    CursorIM = { bg = c.bg_reversed, fg = c.fg_reversed },
    ...
    NormalNC = {
      fg = c.fg_muted,
      bg = opts.transparent and c.none or (opts.dim_inactive and Util.blend_bg(c.bg, 0.9) or c.bg),
    },
