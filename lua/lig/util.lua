...
---@param hex string
function M.darker(hex)
  return M.blend_bg(hex, 0.7, "#000000")
end

---@param hex string
function M.lighter(hex)
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/lig" .. key .. ".json"
end
